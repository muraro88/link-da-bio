...
const App = () => {
  ...
  return (
    ...
    <>
      {/* Bloco de estilo CSS embutido para controle fino de fontes, animações e do modal. */}
      <style>
        {`
        /* Importa as fontes do Google Fonts para um design mais elegante. */
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Inter:wght@400;600&display=swap');

        /* Define a cor de fundo para a página inteira */
        body {
            background-color: #D1D5DB; /* Equivalente a bg-gray-300 */
        }
        
        /* Define a fonte 'Playfair Display' para o título principal (h1). */
        h1 {
        ...
        /* Efeito de 'levantar' ao passar o mouse sobre os botões. */
        .link-button-animation:hover {
            transform: translateY(-2px);
        }

        /* Efeito de hover específico para o botão do WhatsApp para não perder a cor. */
        .link-whatsapp:hover {
            background-color: #084d54;
        }
        
        /* Estilo para o fundo do modal: cobre a tela toda, fica semi-transparente e desfocado. */
        .modal-overlay {
        ...
        /* Classe 'open' torna o modal visível com uma animação de fade-in. */
        .modal-overlay.open {
            display: flex;
            opacity: 1;
        }

        /* Estilo do conteúdo do modal: caixa central com bordas arredondadas e sombra. */
        .modal-content {
            ...
            max-width: 90%;
            width: 450px;
            transform: scale(0.9); /* Começa um pouco menor para a animação de 'pop-up'. */
            transition: transform 0.3s cubic-bezier(0.68, -0.55, 0.27, 1.55);
        }

        /* Quando o modal está aberto, o conteúdo cresce para o tamanho normal. */
        .modal-overlay.open .modal-content {
            transform: scale(1);
        }

        /* Gradiente para o efeito de fade na imagem do hero. */
        .hero-fade {
            background: linear-gradient(to top, rgb(243 244 246 / 1) 20%, rgb(243 244 246 / 0) 100%);
        }

        /* Sombra mais forte no texto do hero para melhor legibilidade contra o fundo. */
      ...
      <div className="min-h-screen w-full flex items-center justify-center p-4">
        ...
        <div className="bg-gray-100 rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden">
          ...
          <div className="relative h-72 text-center">
            ...
            <div className="absolute bottom-0 left-0 w-full h-3/4 hero-fade"></div>
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 hero-text">
                ...
                <h2 className="text-2xl font-semibold text-white">Nutrologia em Natal - RN | CRM RN 5569</h2>
            </div>
          </div>
          ...
          <div className="p-8 text-center">
              <p className="text-gray-500 leading-relaxed mb-8 -mt-4">
                [Médica Nutróloga com foco em emagrecimento, performance e longevidade. Agende sua consulta e inicie a sua jornada para uma vida mais saudável!]
              </p>
              ...
              <div className="w-full flex flex-col gap-6">
                ...
                <a href="https://www.doctoralia.com.br/seu-perfil" target="_blank" rel="noopener noreferrer"
